use crate::{Piece, Square, errors::MoveGenError, moves::make_move::Move, position::Position};

pub fn get_possible_moves(position: &Position, from_square: Square) -> Result<Vec<Move>, MoveGenError>{
