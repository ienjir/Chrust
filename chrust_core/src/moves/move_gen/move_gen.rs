use crate::{ColoredPiece, Piece, Side, Square, errors::ChessError, moves::make_move::Move, position::Position};

impl Position {
	pub fn get_legal_moves(&mut self, from_square: Square, side_to_move: Side) -> Result<Vec<Move>, ChessError> {
