...
fn w_pawn_c2() {
    ...
    assert!(has_move(
        ...
        10,
        26,
        MoveKind::DoublePawnPush { passed_square: 18 }
    ));
...
fn b_pawn_c7() {
    ...
    assert!(has_move(
        ...
        50,
        34,
        MoveKind::DoublePawnPush { passed_square: 42 }
    ));
...
fn w_pawn_a2_edge_capture_b3() {
    ...
    assert!(has_move(
        ...
        8,
        24,
        MoveKind::DoublePawnPush { passed_square: 16 }
    ));
...
fn b_pawn_h7_edge_capture_g6() {
    ...
    assert!(has_move(
        ...
        55,
        39,
        MoveKind::DoublePawnPush { passed_square: 47 }
    ));
...
fn no_piece_e2() {
    ...
    assert_eq!(
        pos.pawn_targets(12),
        Err(ChessError::NoPieceOnSquare { square: 12 })
    )
}
...
fn w_pawn_e5_en_passant_d6() {
    ...
    assert!(has_move(
        ...
        36,
        43,
        MoveKind::EnPassant { capture_square: 35 }
    ));
}
...
fn w_pawn_a7_promotion() {
    ...
    pos.board[48] = Some(ColoredPiece {
        piece: Piece::Pawn,
        side: Side::White,
    });
...
fn b_pawn_h2_promotion() {
    ...
    pos.board[15] = Some(ColoredPiece {
        piece: Piece::Pawn,
        side: Side::Black,
    });
...
fn w_pawn_b7_promotion_capture_on_a8() {
    ...
    pos.board[49] = Some(ColoredPiece {
        piece: Piece::Pawn,
        side: Side::White,
    });
...
fn b_pawn_d7_blocked_on_transit_square() {
    ...
    pos.board[51] = Some(ColoredPiece {
        piece: Piece::Pawn,
        side: Side::Black,
    });
